...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
       ...
       trimmedArmorItem(ModItems.CRUST_HELMET);
       trimmedArmorItem(ModItems.CRUST_CHESTPLATE);
       trimmedArmorItem(ModItems.CRUST_LEGGINGS);
       trimmedArmorItem(ModItems.CRUST_BOOTS);
    }
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = SandwichCraft.MOD_ID; // Change this to your mod id
